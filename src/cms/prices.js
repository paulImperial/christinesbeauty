  ...
  },
  {
    ...
    services: [
      ...
      },
      {
		...
		extraInfo: '(Cleanse, tone, exfoliate, facial massage (including essential oils tailored to you), moisturise, deep mask, neck massage, extraction and hot towels).',
		price: 30,
		time: '60 minutes',
      },
      {
		treatment: 'Platinum Facial',
		extraInfo: '(Cleanse, deep cleanse, tone, exfoliate, facial massage (including essential oils tailored to you), moisturise, deep specialised mask, massage on the neck (plus arms and hands or legs and feet), extraction, hot towels and deep moisturise).',
		price: 40,
		time: '75 minutes',
      },
    ],
