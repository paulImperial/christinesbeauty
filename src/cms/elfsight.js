  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t) {
      ...
      return function (t, s, g) {
        for (
          var h, b, v = r(t), m = i(v), w = o(s, g, 3), y = a(m.length), x = 0, C = n ? d(t, y) : c ? d(t, 0) : void 0;
          y > x;
          x++
        )
      ...
      c = function (e, t, n) {
        ...
        (l.initialize = function () {
          ...
          (l.requireWidget = function (e) {
            'string' != typeof e && l.logError('Widget Public ID required and should be a string', { pid: e }),
                ...
                if (e.buffer && e.buffer.length) {
                  e.buffer.forEach(function (t) {
                    if (e.steps && !e.steps.length)
                      e.steps.push({ app: t.app, widgetId: t.widgetId, event: t.event, count: t.count });
                    else {
                      var n = !1;
